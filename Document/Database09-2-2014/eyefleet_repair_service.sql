...
CREATE TABLE `repair_service` (
  ...
  KEY `fk_repair_service_truck1_idx` (`truck_id`),
  CONSTRAINT `fk_repair_service_truck1` FOREIGN KEY (`truck_id`) REFERENCES `truck` (`truck_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `repair_service` VALUES (1,'2014-08-30','sijhcnsdkjcsd','repaired','245 - 14.2'),(2,'2014-08-30','sijhcnsdkjcsd','repaired','245 - 14.2');
...
-- Dump completed on 2014-09-02 18:06:41
